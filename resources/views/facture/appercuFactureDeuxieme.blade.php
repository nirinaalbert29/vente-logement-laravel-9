...
<body>
    ...
    @section("contenu")
        <div class="container">
                ...
                <div class="col-xl-8" id="print">
                    <div class="card shadow mb-10">
                        ...
                        <div
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Facture de Payement 2em trance N° {{$fact->id_vente}}</h6>
            ...
            <br>
            <a href="/facturationDeuxieme" class="btn btn-danger">Retour</a>
        </div>
